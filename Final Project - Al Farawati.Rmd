...
# Create a new column with abbreviated labels
...
```{r 13.2 plot}
# exclude rows with NA growth_rate
...
# Convert yr to numeric and naics_code_descr to factor
